...
export function FlexWrapViewMore({
  ...
  return (
    ...
    >
      <div
        ref={containerRef}
        className={`${classNames.childrenWrapper} p-${padding} w-full flex flex-wrap justify-center gap-2 overflow-hidden transition-[max-height] duration-400 ease-in-out`}
        style={{
